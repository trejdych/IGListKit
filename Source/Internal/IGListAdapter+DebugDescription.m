...
- (NSArray<NSString *> *)debugDescriptionLines {
    ...
    if (self.registeredCellReuseIdentifiers.count > 0) {
        [debug addObject:@"Registered cell reuse identifiers:"];
        [debug addObject:[self.registeredCellReuseIdentifiers description]];
    }
