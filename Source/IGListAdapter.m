...
- (void)setCollectionView:(UICollectionView *)collectionView {
    ...
    if (_collectionView != collectionView || _collectionView.dataSource != self) {
        ...
        // the first time
        _registeredCellReuseIdentifiers = [NSMutableSet new];
...
- (UICollectionViewCell *)dequeueReusableCellOfClass:(Class)cellClass
    ...
    NSIndexPath *indexPath = [self indexPathForSectionController:sectionController index:index usePreviousIfInUpdateBlock:NO];
    if (![self.registeredCellReuseIdentifiers containsObject:identifier]) {
        [self.registeredCellReuseIdentifiers addObject:identifier];
